...
export async function bootstrap() {
  ...
  // when dev mode is on, mirror console.* into the overlay and auto-register
  // the built-in log tool that displays it (lazily loaded into the same chunk);
  // existing console.* calls anywhere in the stack then show up with no changes
  if(_devOverlay) {
